...
public class OpenBlocksCode {
    public HashMap<String, String> code_templates;
    public ArrayList<BlockCode> blocks = new ArrayList<>();

    public OpenBlocksCode(HashMap<String, String> code_templates) {
        this.code_templates = code_templates;
    }

    public OpenBlocksCode(HashMap<String, String> code_templates, ArrayList<BlockCode> blocks) {
        this.code_templates = code_templates;
        this.blocks = blocks;
    }
}
